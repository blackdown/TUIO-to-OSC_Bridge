    ...
    Column {
        ...
        Rectangle {
            ...
            RowLayout {
                ...
                Label {
                    text: "Active: " + Bridge.cursorModel.rowCount() + " / " +
        ...
        ListView {
            ...
            delegate: Rectangle {
                ...
                Row {
                    ...
                    // X
                    Label { width: 70;  height: rowDelegate.height; text: rowDelegate.x.toFixed(4); font.pixelSize: 12; font.family: "monospace"; color: "#cfd8dc"; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight }
                    // Y
                    Label { width: 70;  height: rowDelegate.height; text: rowDelegate.y.toFixed(4); font.pixelSize: 12; font.family: "monospace"; color: "#cfd8dc"; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight }
                    // X Vel
